...
function showUnit(a) {
    ...
    for (i in jsonUnits.units) {
        if (a == jsonUnits.units[i].name) {
           ...
           levels.innerHTML =  "<p><x-medal_trooper> </x-medal_trooper> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Trooper"+ jsonUnits.units[i].level_trooper + "<p><x-medal_veteran> </x-medal_veteran> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Veteran" + jsonUnits.units[i].level_veteran + "<p><x-medal_expert> </x-medal_expert> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Expert" + jsonUnits.units[i].level_expert + "<p><x-medal_elite> </x-medal_elite> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Elite" + jsonUnits.units[i].level_elite + "<p><x-medal_champion> </x-medal_champion> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Champion <ul> <li> +10 <x-hp> </x-hp></li></ul>";
            ...
            for (x in jsonUnits.units[i].passives) {
             ...
             for (j in jsonUnits.units[i].unit_types) {
                addUnitTypeIcon(jsonUnits.units[i].unit_types[j].slug);
